...
def main():
    ...
    # Visualize mixed compounds
    if mixed_compounds_groups:
        process_and_visualize_mixed_compounds(coord_df, mixed_compounds_groups, coord_sheet_name, element_dict)
